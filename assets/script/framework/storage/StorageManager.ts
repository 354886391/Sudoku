...
export class StorageManager extends Singleton<StorageManager>() {
    ...
    private _keyConfig: string = 'Gamer';//游戏英文名称
    ...
    start() {
        ...
        var content;
        if (sys.isNative) {
            var valueObject = fileUtils.getValueMapFromFile(this._path);
    ...
    public save() {
        ...
        fileUtils.writeValueMapToFile(valueObj, this._getConfigPath());
    }
